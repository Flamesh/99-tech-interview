  ...
  return (
    <div className="bg-gray-700 rounded-xl p-4 mb-1">
      <div className="flex justify-between mb-2">
        <label className="text-gray-400 text-sm">{isTargetExchange ? 'To' : 'From'}</label>
      ...
      <div className="flex items-start justify-between">
        <div className="flex flex-col relative">
          <input
            ...
            className={`bg-transparent text-white text-2xl outline-none border-b border-gray-600 focus:border-blue-500 mr-2 ${error ? "border-red-500" : ""}`}
            placeholder="0.0"
